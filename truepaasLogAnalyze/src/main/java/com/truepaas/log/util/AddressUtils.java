...
//        String ip = "118.213.1.79";
        String ip ="192.168.101.104";
    ...
    public  static String getRs(String path, String params, String encoding){
        ...
        try {
            ...
            connection.setConnectTimeout(20000);// 设置连接超时时间，单位毫�?

            connection.setReadTimeout(20000);// 设置读取数据超时时间，单位毫�?
